...
(function () {
    ...
    function FastClick(layer, options) {
        ...
        // FastClick's onClick handler. Fix this by pulling out the userController-defined handler function and
    ...
    /**
     * Windows Phone 8.1 fakes userController agent string to look like Android and iPhone.
     *
     * @type boolean
     */
    ...
    FastClick.prototype.onTouchStart = function (event) {
        ...
        if (deviceIsIOS) {
            ...
            if (!deviceIsIOS4) {
                ...
                // when the userController next taps anywhere else on the page, new touchstart and touchend events are dispatched
                ...
                // 1) the userController does a fling scroll on the scrollable layer
                // 2) the userController stops the fling scroll with another tap
                // then the event.target of the last 'touchend' event will be the element that was under the userController's finger
    ...
    FastClick.prototype.onTouchEnd = function (event) {
        ...
        if (targetTagName === 'label') {
            ...
            // Case 2: Without this exception for input elements tapped when the document is contained in an iframe, then any inputted text won't be visible even though the value attribute is updated as the userController types (issue #37).
    ...
    FastClick.prototype.onMouse = function (event) {
        ...
        if (!this.needsClick(this.targetElement) || this.cancelNextClick) {
            ...
            // Prevent any userController-added listeners declared on FastClick element from being fired.
    ...
    FastClick.prototype.onClick = function (event) {
        ...
        // Very odd behaviour on iOS (issue #18): if a submit element is present inside a form and the userController hits enter in the iOS simulator or clicks the Go button on the pop-up OS keyboard the a kind of 'fake' click event will be triggered with the submit-type input element as the target.
    ...
    FastClick.notNeeded = function (layer) {
        ...
        if (chromeVersion) {
            ...
            if (deviceIsAndroid) {
                ...
                if (metaViewport) {
                    // Chrome on Android with userController-scalable="no" doesn't need FastClick (issue #89)
                    if (metaViewport.content.indexOf('userController-scalable=no') !== -1) {
                        return true;
                    }
        ...
        if (deviceIsBlackBerry10) {
            ...
            if (blackberryVersion[1] >= 10 && blackberryVersion[2] >= 3) {
                ...
                if (metaViewport) {
                    // userController-scalable=no eliminates click delay.
                    if (metaViewport.content.indexOf('userController-scalable=no') !== -1) {
                        return true;
                    }
        ...
        if (firefoxVersion >= 27) {
            ...
            metaViewport = document.querySelector('meta[name=viewport]');
            if (metaViewport && (metaViewport.content.indexOf('userController-scalable=no') !== -1 || document.documentElement.scrollWidth <= window.outerWidth)) {
                return true;
            }
        }
